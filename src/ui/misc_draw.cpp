...
void Letter(int x, int y, char ltr, int ys, int y2)
{
    switch(ltr)
    {
        ...
        case 31: Copy(PFONT, x, y, 111, 64, 111 + 5, 64 + 6); break; // FX ARROW LO BACK
        case 32: Copy(PFONT, x, y, 138, 64, 138 + 5, 64 + 6); break; // FX ARROW HI BACK
        case 33: Copy(PFONT, x, y, 165, 64, 165 + 5, 64 + 6); break; // FX ARROW SEL BACK
    }
}
